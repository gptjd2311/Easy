			...
			<section id="join-section">
				<header>
					<center>
						...
						<h1 id="join-newmem">회원 가입을 환영합니다</h1>
					</center>
				</header>
				<article>
					<fieldset>
						<div class="newreg">
							<form action="member_join" method="post" name="frm">
								<table>
									<tr>
										<th>아이디</th>
									...
									<tr>
										...
										<td><input type="text" id="sample6_address"
											class="join-id" name="memAdd_2" placeholder="주소"></td>
									</tr>
									<tr>
										<th>상세주소</th>
										<td><input type="text" id="sample6_detailAddress"
											name="memAdd_3" class="join-id" placeholder="상세주소"></td>
								...
								<center>
									<input id="join-button" type="submit" value="회원 가입"
