		...
		<div class="container">
			<section>
				...
				<c:if test="${empty loginUser && empty loginAdmin }">
					...
					<ul id="button-ul">
						<li><a href="member_join_form" class="button-index-sign"
							target="_blank"> 회원가입</a></li>

						<li><a href="login" class="button-index-login"
				...
				<c:if test="${!empty loginUser}">
					...
					<ul id="button-ul">
						<li><a href="product_buy_0" class="button-index-sign"
							target="_blank"> 세탁예약</a></li>
						<li><a href="logout" class="button-index-login"
							target="_blank"> 로그아웃</a></li>
					</ul>
					<hr>
				...
				<c:if test="${!empty loginAdmin }">
					...
					<ul id="button-ul">
						<li><a href="member_listAll" class="button-index-sign"
							target="_blank"> 회원관리</a></li>
						<li><a href="reserve_listAll" class="button-index-login"
	...
	<div id="main" class="wrapper style1">
		<section class="container">
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=85162d856efdd70a63f4194b7e029ca8"></script>
			<script type="text/javascript"
