				...
				<ul>
					...
					<li><a href="login">Login</a>
						<ul>
							...
							<li><a href="member_join_form">회원가입</a></li>
						</ul></li>
				</ul>
				</nav>
			</div>
		...
		<div id="header">
			<div class="container">
				...
				<ul>
					...
					<br>
					<li><a href="index">Home</a></li>
					<li><a href="product_buy_0">Laundry</a>
						<ul>
							<li><a href="product_buy_0">세탁 예약</a></li>
						</ul></li>
					<li><a href="listSearch">Service Menu</a>
						<ul>
							<li><a href="listSearch">공지사항 & 할인/이벤트</a></li>
							<li><a href="board_sug">건의사항 & 불만족 신고</a></li>
						</ul></li>
					<li><a href="mypage">mypage</a>
						<ul>
							<li><a
								href="member_update_form?memId=<%=id%>">개인정보
									수정</a></li>
							<li><a
								href="reserve_list?memId=<%=id%>">나의
									예약</a></li>
							<li><a
								href="reserve_bucket?memId=<%=id%>">장바구니</a></li>
						</ul></li>
		...
		<div id="header">
			<div class="container">
				...
				<ul>
					...
					<li><a href="listSearch">ServiceMenu</a>
						<ul>
							<li><a href="listSearch">공지사항 & 할인/이벤트</a></li>
							<li><a href="board_sug">건의사항 & 불만족 신고</a></li>
						</ul></li>
					<li><a href="mypage">mypage</a>
						<ul>
							<li><a
								href="admin_update_form?memId=<%=id%>">개인정보
									수정</a></li>
							<li><a
								href="reserve_list?memId=<%=id%>">나의
									예약</a></li>
					...
					<li><a href="admin">admin page</a>
						<ul>
							<li><a href="admin_join_form">관리자계정추가</a></li>
							<li><a href="member_listAll">회원 관리</a></li>
							<li><a href="reserve_listAll">예약 관리</a></li>
						</ul></li>
					<li><a href="logout">Logout</a></li>
				</ul>
				</nav>
