	...
	<div id="main" class="wrapper style1">
		<section class="container">
			...
			<script>
				...
				mapOption = {
					center : new kakao.maps.LatLng(37.26790415020807, 127.00063699000602), // 지도의 중심좌표
					level : 9
				// 지도의 확대 레벨
				};
				...
				var circle = new kakao.maps.Circle({
				    center : new kakao.maps.LatLng(37.26790415020807, 127.00063699000602),  // 원의 중심좌표 입니다 
