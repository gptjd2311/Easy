	...
	<table id="CommentTable">
		...
		<tr id="tabcontent_head">
			<td style="border: 1px solid lightgray"><img
				src="${path}/resources/images/personvec1.jpg"></td>
		...
		<div>
			<c:forEach items="${bcommentDtoList}" var="bcommentDtoList">
				...
				<table id="tabcontent">
					...
					<tr id="tabcontent_head">
						...
						<td><img src="${path}/resources/images/personvec1.png">
							...
							${bcommentDtoList.NOTICE_COMMENT_DATE} &nbsp; <input
							id="tabcontent_btn" type="button" value="답글달기"
				...
				<form name="frm" method="post" action="BCommentReplyInsert">
					...
					<input type="hidden" name="pageDataCount" value="${bSearchDto.pageDataCount}" /> <input type="hidden"
						value="${bcommentDtoList.NOTICE_COMMENT_GROUPID}"
