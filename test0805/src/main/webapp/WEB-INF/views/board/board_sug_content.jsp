...
<body class="no-sidebar">
	<form method="post" action="board_sug.do" enctype="multipart/form-data" name="frm">
		...
		<div class="container">
			...
			<c:choose>
				<c:when test="${!empty loginAdmin}">
					...
					<a
						href="board_sug_delete.do?bId=${dto.bId}&page=${bSearchDto.currentPageNum }
											&pageDataCount=${bSearchDto.pageDataCount }
											&searchCol=${bSearchDto.searchCol }
											&searchVal=${bSearchDto.searchVal }"><button
			...
			<c:if test="${loginUser == bName}">
				<a
					href="board_sug_modify_view.do?bId=${dto.bId }&bName=${dto.bName}&page=${bSearchDto.currentPageNum }
											&pageDataCount=${bSearchDto.pageDataCount }
											&searchCol=${bSearchDto.searchCol }
											&searchVal=${bSearchDto.searchVal }"><button
